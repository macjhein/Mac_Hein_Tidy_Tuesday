...
ggplot()+
  ...
  coord_map(projection = "mercator",
            xlim = c(115, 180),
            ylim = c(-10, -40)
            ) + # can set limits of longitude (xlim) and latitude (ylim?) to zoom in
  labs(title = "Locations of numbat sightings in Australia", x = "Longitude", y = "Latitude", 
       color = "Subspecies") +
  scale_colour_manual(values = c("lightseagreen", "violetred1"), aesthetics = c("color", "fill")) +
